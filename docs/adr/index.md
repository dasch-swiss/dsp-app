...
ADR-0001 is the anchor: it defines the tags, the dependency direction, and the order in which they can be switched on without breaking the build. The other four each take one part of it further.
...
0004 and 0005 are on the critical path for 0001: the constraint block in 0001 cannot be switched on until the cross-feature symbols they describe have moved.
